...
export function CompanyStats({ companies, loading }: CompanyStatsProps) {
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      <div className="bg-white rounded-rm-trip-smooth border border-gray-100 px-5 py-4">
        <p className="text-xs font-semibold text-rm-trip-text-muted mb-2">Total Companies</p>
        <p className="font-rm-trip-heading font-semibold text-xl text-rm-trip-brand">
      ...
      <div className="bg-white rounded-rm-trip-smooth border border-gray-100 px-5 py-4">
        ...
        <p className="font-rm-trip-heading font-semibold text-base text-rm-trip-state-success truncate">
      ...
      <div className="bg-white rounded-rm-trip-smooth border border-gray-100 px-5 py-4">
        ...
        <p className="font-rm-trip-heading font-semibold text-base text-rm-trip-text">
          {loading ? (
